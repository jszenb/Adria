...
<div class="fonds form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Ajouter un fonds') ?></legend>
        <h4>Identification du fonds</h4>
		<?php
            echo $this->Form->input('nom');
            
			/*echo $this->Form->input('annee_deb',['size'=>4, 'min'=>0, 'type' => 'int', 'label' => 'Date extrême (année de début)']);	
            echo '<p>'.$this->Form->input('annee_fin',['size'=>4, 'min'=>0,  'type' => 'int', 'label' => 'Date extrême (année de fin)']);
			echo '<p><p>'.$this->Form->checkbox('ind_annee', ['hiddenField' => true]).'Dates extrêmes à renseigner';			*/
		...
		<?php
			...
			echo $this->Form->input('type_doc_afferents._ids', ['options' => $typeDocAfferents, 'label' => 'Document(s) afférent(s) au mode d\'entrée', 'required' => true, 'title' => 'Pour sélectionner/déselectionner plus d\'une valeur, maintenez la touche [ctrl] appuyée et cliquez sur les valeurs à sélectionner/déselectionner' ]);					
		...
		<?php
			...
			//echo $this->Form->input('nb_ml', ['size'=>5, 'min' => 0, 'type' => 'float', 'label' => 'Volumétrie en mètres linéaires']);
			//echo '<p>'.$this->Form->checkbox('ind_nb_ml_inconnu', ['hiddenField' => false]).' Volumétrie en mètres linéaires inconnue';			         
			//echo $this->Form->input('nb_go', ['size'=>5, 'min' => 0, 'type' => 'float', 'label' => 'Volumétrie en giga-octets']);			
			//echo '<p>'.$this->Form->checkbox('ind_nb_go_inconnu', ['hiddenField' => false]).' Volumétrie en giga-octets inconnue';	
		...
		<?php
            ...
            //echo $this->Form->input('ind_suppr');
		...
		?>
                ...
                <table>
                        <tr>
                                ...
                                <td>
                                        <?php
                                        echo $this->Form->radio('stockage', [LIB_STOCKAGE_CIBLE[0], LIB_STOCKAGE_CIBLE[1], LIB_STOCKAGE_CIBLE[2], LIB_STOCKAGE_CIBLE[3] ], ['default' => 0]);
                                        ?>
                                </td>
                        </tr>
                </table>
                ...
                <table>
                        <tr>
                                ...
                                <td>
                                        <?php
                                        echo $this->Form->radio('communication', [LIB_COMMUNICATION[0], LIB_COMMUNICATION[1], LIB_COMMUNICATION[2]], ['default' => 0]);
                                        ?>
                                </td>
                        </tr>
                </table>
