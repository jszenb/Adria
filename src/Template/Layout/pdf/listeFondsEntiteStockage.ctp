...
/********************************************************************************************/
// Application ADRIA
// ListeFondsEntiteStockage.ctp
// Template de génération de la liste des fonds par entité documentaire et lieu de stockage
// cible
//
...
$pdf->SetTextColor(0);
$pdf->Write(6,"Liste détaillée des fonds par entité documentaire et par lieu de stockage cible", '', false, 'L');
$pdf->Ln(10);	

// ------------------------------------------------------------------------------------------
// Constitution de l'entête du tableau de résultats : avec le titre des colonnes
// ------------------------------------------------------------------------------------------
$header = array('', 'Nom du fonds', "Mètres\nlinéaires", "Communicable ?");
...
foreach($fonds as $row) {
	...
	$pdf->Cell($w[3], 6, addslashes(LIB_COMMUNICATION[$row->communication]), 'LR', 0, 'L', $fill);
